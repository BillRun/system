...
data_end_code='.result.forEach(      function(obj) {         print("data," + dir + "," + network + ",'$year'-'$month'-" + day + "," +  (obj._id.match(/^37\.26/) ? "GT" : (obj._id.match(/^62\.90/) ? "CELL" : "OTHER") )  +",INTERNET_BY_VOLUME" + "," + obj.count + "," + obj.usagev);});}';

...
class Generator_WkPdf extends Billrun_Generator_Pdf {
	...
	public function __construct($options) {
		...
		$this->render_detailed_services = Billrun_Util::getFieldVal($options['detailed_services'], Billrun_Factory::config()->getConfigValue(self::$type . '.default_print_detailed_services', FALSE));
	}
...
//																		array('totals.before_discounts'=>array('$not' => array('$gt'=>-$this->invoice_threshold,'$lt'=>$this->invoice_threshold))) 
	...
	protected function accountSpecificViewParams($billrunData) {
		...
		$this->view->assign('render_detailed_services', $this->render_detailed_services);

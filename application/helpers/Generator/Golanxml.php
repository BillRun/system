				...
				if (isset($planInCycle['include']['groups'])) {
					...
					foreach ($planInCycle['include']['groups'] as $group_name => $group) {
						...
						if (isset($group['data'])) {
							...
							$this->writer->writeElement('DATA_CAPACITY', (($group['data'] === 'UNLIMITED') && (($group_name == 'VF') || isset($group['limits']['vf'],$group['limits']['days']))) ? 6291456 : $group['data']); // Hard coded 6GB for vf data abroad

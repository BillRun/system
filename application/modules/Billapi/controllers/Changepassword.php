...
class ChangepasswordController extends BillapiController {
	...
	protected function checkPermissions() {
		...
		if ($adjustedRequest[Billrun_Utils_Security::TIMESTAMP_FIELD] < $timeLimit) {
			throw new Exception('Your password reset link has expired. Please request new reset password.');
		}
		...
		throw new Exception('Oops! Something went wrong. Please request new reset password.');
	}

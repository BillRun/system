...
// 			if (!preg_match('/^(?=62\.90\.|37\.26\.|85\.64\.|172\.28\.|176\.12\.158\.|80\.246\.131|80\.246\.132|37\.142\.167|91\.135\.96\.|91\.135\.99\.(19[2-9]|2))/', $line['sgsn_address'])) {
			if (!preg_match('/^(?=62\.90\.|37\.26\.|85\.64\.|172\.28\.|172\.16\.24\.|172\.17\.224\.|172\.25\.|172\.27\.|176\.12\.158\.|80\.246\.131|80\.246\.132|37\.142\.167|91\.135\.96\.|91\.135\.99\.(19[2-9]|2)|10\.224\.213|10\.192\.213)/', $line['sgsn_address'])) {
				$roamingLines[] = $line;
			}
		}

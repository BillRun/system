...
//	}
	...
	public function parseData($type, $line, Billrun_Parser &$parser) {
		...
		if (isset($this->nsnConfig[$data['record_type']])) {
			...
			$data['urt'] = new MongoDate(Billrun_Util::dateTimeConvertShortToIso((string) (isset($data['charging_start_time']) ? $data['charging_start_time'] : $data['call_reference_time']), self::DEFAULT_TIME_OFFSET));
		}

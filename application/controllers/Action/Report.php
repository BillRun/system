...
//		'targetImsi' =>  ['$in'=>['called_imsi','forwarding_imsi','forwarded_to_imsi']],
		...
		'cellId' =>  ['$in'=>['called_subs_first_ci','calling_subs_first_ci', 'called_subs_last_ci','calling_subs_last_ci', 'user_location_information.eci','user_location_information.ci']],
...
//		'sourceIp6' =>  ['$in'=>['ipmapping.ipv6']],
		...
		'served_pdp_address' =>  ['$in'=> ['served_pdp_address','served_pdp_address_ext']],
	];

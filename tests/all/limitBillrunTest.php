...
/**
    ...
    public function test_expandSubRevisions_3(){
        //the main revision starts earlier and ends later + 
        // 3 services that end on the same revision and each starts on a different date – 5 revisions 
        $plan = 
        [
    ...
    public function test_expandSubRevisions_5(){
        //Overlapping service revisions, and the main revision starts before and after
        $plan = 
        [
    ...
    public function test_expandSubRevisions_8(){

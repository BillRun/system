...
runOnce(lastConfig, 'BRCD-4422-1', function () {
	lastConfig.worker = {
		...
		"iteration": 2000000, // time the iterate when job queue is empty
		"job_timeout":900, // job timeout
		"concurrent_limit": 4, // how many jobs run in parallel in single instance
//		cron: {

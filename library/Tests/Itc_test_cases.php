	...
	public function tests() {
		...
		$cases = [
			...
			["test_num" => 37,
				...
				"file_type" => "ICT", "expected" => [['aprice' => 0.001877, 'cf.call_direction' => 'O', 'cf.product' => 'FIX', "cf.scenario" => "OSD", "cf.cash_flow" => "E", "cf.component" => "ICTDC" ,"sne"=>array('billrun')]]
			],
			["test_num" => 38,
				"data" =>
				[
			...
			["test_num" => 39,
				"file_type" => "ICT", 
				"expected" => [
					['aprice' => 0.0155, 'cf.call_direction' => 'TO', 'cf.product' => 'IVOICE', "cf.scenario" => "TSD", "cf.cash_flow" => "E", "cf.component" => "ICTDC","sne"=>array('billrun')],
					['aprice' => 0.0403, 'cf.call_direction' => 'TI', 'cf.product' => 'IVOICE', "cf.scenario" => "TSD", "cf.cash_flow" => "R", "cf.component" => "ICTDC","sne"=>array('billrun')],
				]
			],
			["test_num" => 40,
				"file_type" => "ICT", 
				"expected" => [
					['aprice' => 0.049211333, 'cf.call_direction' => 'TO', 'cf.product' => 'FIX', "cf.scenario" => "TSD_AB", "cf.cash_flow" => "E", "cf.component" => "ICTDC","sne"=>array('billrun')],
					['aprice' => 0.051733333, 'cf.call_direction' => 'TI', 'cf.product' => 'FIX', "cf.scenario" => "TSD_AB", "cf.cash_flow" => "R", "cf.component" => "ICTDC","sne"=>array('billrun')],				]
			],
			["test_num" => 41,
				"file_type" => "ICT", 
				"expected" => [
					['aprice' => 0.00517, 'cf.call_direction' => 'TO', 'cf.product' => 'MOB', "cf.scenario" => "TSD_AB", "cf.cash_flow" => "E", "cf.component" => "ICTDC","sne"=>array('billrun')],
					['aprice' => 0.006, 'cf.call_direction' => 'TI', 'cf.product' => 'MOB', "cf.scenario" => "TSD_AB", "cf.cash_flow" => "R", "cf.component" => "ICTDC","sne"=>array('billrun')],
				]
			],
			["test_num" => 42,
				"file_type" => "ICT", 

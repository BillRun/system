...
class Test_Case_42752
{
    ...
    public function test_case()
    {
        ...
        'price'=>[["price" => 100, "from" => 0, "to" => "UNLIMITED"]], 'rounding_rules'=> ['rounding_type'=>'down', 'rounding_decimals'=>3]]);
        ...
        return [
            'test' => [
                'label' => "Discounts rounding inheret from plan (full discount)- rounding_type: down rounding_decimals: 3",
                'test_number' => 42752,
                'aid' => $account['aid'],
                'function' => [
                    'basicCompare',

...
class Test_Case_42751
{
    ...
    public function test_case()
    {
        ...
        'price'=>[["price" => 100, "from" => 0, "to" => "UNLIMITED"]], 'rounding_rules'=> ['rounding_type'=>'nearest', 'rounding_decimals'=>2]]);
        ...
        return [
            'test' => [
                'label' => "Discounts rounding inheret from plan (full discount)- rounding_type: nearest rounding_decimals: 2",
                'test_number' => 42751,
                'aid' => $account['aid'],
                'function' => [
                    'basicCompare',

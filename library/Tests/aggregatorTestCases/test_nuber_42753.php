...
class Test_Case_42753
{
    ...
    public function test_case()
    {
        ...
        'price'=>[["price" => 100, "from" => 0, "to" => "UNLIMITED"]], 'rounding_rules'=> ['rounding_type'=>'up', 'rounding_decimals'=>3]]);
        ...
        return [
            'test' => [
                'label' => "Discounts rounding inheret from plan (full discount)- rounding_type: up rounding_decimals: 3",
                'test_number' => 42753,
                'aid' => $account['aid'],
                'function' => [
                    'basicCompare',

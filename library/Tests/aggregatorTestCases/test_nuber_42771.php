...
class Test_Case_42771
{
    ...
    public function test_case()
    {
        ...
        generat_test_data::setTestNumber(42771);
        ...
        return [
            'test' => [
                'label' => 'non-unique discount key- differnt discounts for different subscribers + general discount with this key not exists',
                'test_number' => 42771,
                "aid" => $account['aid'],

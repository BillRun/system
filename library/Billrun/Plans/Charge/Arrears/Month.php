...
class Billrun_Plans_Charge_Arrears_Month extends Billrun_Plans_Charge_Base {
	...
	protected function getProrationData($price, $cycle = false) {
		...
		return [	'start_date' => new Mongodloid_Date(Billrun_Plan::monthDiffToDate($price['start'],  $proratedActivation )),
					...
					'end_date' => new Mongodloid_Date(Billrun_Plan::monthDiffToDate($price['end'],  $proratedActivation , FALSE, $this->deactivation ,$this->deactivation && $this->cycle->end() > $this->deactivation)),

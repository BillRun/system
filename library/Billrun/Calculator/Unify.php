			...
			$this->unificationFields = array(
				'ggsn' => array(
					...
					'stamp' => array(
						...
						'field' => array('in_plan', 'out_plan', 'over_plan', 'aprice', 'data_volume_5g'),
					),
					'fields' => array(
						...
						'$inc' => array('usagev', 'aprice', 'apr', 'fbc_downlink_volume', 'fbc_uplink_volume', 'duration', 'in_plan', 'out_plan', 'over_plan', 'data_volume_5g'),
						'_array_map'=> [
                            [

...
class Billrun_Calculator_Customer extends Billrun_Calculator_Base_Rate {
	...
	protected function createBalanceIfMissing($subscriber, $billrun_key, $plan_ref) {
		if (!Billrun_Model_Subscriber::getBalance($subscriber->subscriber_id, $billrun_key)) {
			Billrun_Model_Subscriber::createBalance($billrun_key, $subscriber->subscriber_id, $plan_ref, $subscriber->account_id);
		}
	}

...
//		}
	...
	public function getPossiblyUpdatedFields() {
		return array_merge($this->getCustomerPossiblyUpdatedFields(), array('granted_return_code', 'usagev','foreign'));
	}
	...
	protected function enrichWithSubscriberInformation($row, $subscriber) {
		...
		$enrichedData = array_merge ($enrichedData , array('foreign' => $this->getForeignFields(array('subscriber' => $subscriber ),$row )));

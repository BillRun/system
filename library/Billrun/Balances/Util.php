...
class Billrun_Balances_Util {
	 ...
	 */
	public static function setBalanceValue(&$balance, $value) {
		if (!$balance) {
			return 0;
		}
		...
		Billrun_Util::setFirstValueOfMultidimentionalArray($balance['balance'], $value);
		return true;
	}

	/**
	 * Increment the balance value.
	 * @param array $balance - Balance record
	 * @parm int $value
	 * @return true if successful
	 */
	public static function incBalanceValue(&$balance, $value) {
		if (!$balance) {
			return 0;
		}
		...
		Billrun_Util::incFirstValueOfMultidimentionalArray($balance['balance'], $value);
		return true;
	}

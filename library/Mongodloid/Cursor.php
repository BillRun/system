...
class Mongodloid_Cursor implements Iterator, Countable {
	...
	public function current() {
		...
		return $this->getRaw ? Mongodloid_Result::getResult($this->_iterator->current(), __FUNCTION__) :  
		new Mongodloid_Entity(Mongodloid_Result::getResult($this->_iterator->current(), __FUNCTION__), null, false);
	}

	  ...
	  _createClass(ComputedRate, [{
	    ...
	    value: function render() {
	      ...
	      var additionalFields = foreignFields.filter(function (field) {
	        return field.get('available_from', '') === 'rate' || 1;
	      }).map(function (filteredField) {
	        var fieldName = filteredField.getIn(['foreign', 'entity'], '');
	        return { value: fieldName, label: (0, _changeCase.titleCase)(fieldName) + ' (foreign field)' };
